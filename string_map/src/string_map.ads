...
--  <any_but_quote>   ::= <any character except quote>
--  <any_but_special> ::= <any character except ';' and ' '>
--  <unquoted_value>  ::= <any_but_quote> {<any_but_special>}
--
...
private
   ...
   Empty_Cursor : constant Cursor := (Length  => 0,
                                      Params  => "",
                                      K_First => 0,
                                      others  => 1);
end String_Map;
