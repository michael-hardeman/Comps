...
package Odbc2 is
   ...
   procedure Disconnect (Connection : Connection_Handle);
   ...
   procedure Commit (Connection : Connection_Handle);

   procedure Rollback (Connection : Connection_Handle);
   --
   ...
   function Is_Open (Cursor : Cursor_Type) return Boolean;
   ...
   --
   type Column_Type is (Integer_Type, Float_Type,
                        String_Type, Date, Unknown);
   ...
   function Get_Column_Type (Cursor : Cursor_Type;
                             Column : Natural) return Column_Type;
